...
class IndicatorView: UIView {
    ...
    /*    DispatchQueue.main.sync {
            ...
            UIView.animate(withDuration: appeareAnimation ? 0.25 : 0) {
                ...
                self.descriptionLabel.isHidden = (description == "" || description == nil) ? true : false
        ...
        set {
            DispatchQueue.main.async {
                ...
                case .standardError, .standard:
                    ...
                    UIView.animate(withDuration: 0.3) {
                        self.mainView.layer.shadowOpacity = 0.9
                        self.imageView.superview?.isHidden = newValue == .standardError ? false : true
                        self.backgroundHelper.backgroundColor = self.accentBackgroundColor
                        self.backgroundView.backgroundColor = self.accentBackgroundColor
                    }
                case .ai:
        ...
        DispatchQueue.main.async {
            ...
            self.descriptionLabel.text = descriptionText
                UIView.animate(withDuration: 0.20) {
                    ...
                    self.descriptionLabel.isHidden = (descriptionText == nil || descriptionText == "") ? true : false
                    ...
                    self.userDataStack.isHidden = descriptionTable == nil ? true : false
                    self.textField.superview?.superview?.superview?.isHidden = descriptionTable == nil ? true : false
